...
Clearly, you can see there's a competitive advantage of launching a browser extension (especially a Chrome extension) over other launching on other platforms. This is especially true if you want to get the most people using your product right away. By sheer numbers alone, launching a Chrome extension gives you 200 times more potential users than an iOS app. If you also consider development costs of a Chrome extension over an iOS app, the advantage grows even more.
...
This space evolves quickly, and it can be sometimes hard to keep up with all the changes with browsers. To help myself keep up to date, I made a Twitter bot [@experimentalweb](https://twitter.com/experimentalweb). I've found it to be a good way to passively keep track of updates from browsers and Internet organizations like W3C.

I intend on expanding the microsite [experimentalweb.net](https://www.experimentalweb.net/) into a digital magazine to showcase new developments on the web and browser features.
